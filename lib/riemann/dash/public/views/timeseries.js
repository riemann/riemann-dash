(function() {
    ...
    var TimeSeriesView = function(json) {
      ...
      self.smoothie = new SmoothieChart({
        grid: {strokeStyle:'transparent', fillStyle:'rgba(255, 255, 255, 0.0)', lineWidth: 1, millisPerLine: 60000},
      ...
      var colorPallette = function() {
        ...
        var DEFAULT = ["#0F87BC", "#D3B803", "#00BB63", "#D41430",
                       "#FF6513", "#9440ed", "#a7ca50", "#bfe746",
